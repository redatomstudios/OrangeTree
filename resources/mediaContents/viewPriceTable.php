...
<script>
	...
	var updateConfirmData = function($source) {
			$months =['Jan', 'Feb', 'Mar', 'Apr', 'May', 'Jun', 'Jul', 'Aug', 'Sep', 'Oct', 'Nov', 'Dec'];
  			$roomType = ['Twin', 'Double', 'King Double'];
		var roomType = $source[0],
				month = $source[1],
				day = $source[2],
				year = $source[3],
				amount = $source[4],
				updateString = 'Book a ' + $roomType[roomType - 1] + ' room on ' + $months[month - 1] + ' ' + day + ', ' + year + ' for &pound;' + amount + '. Check out to continue.';
...
<div class="tabWrapper">
			...
			<tr>
				...
				<td>
					...
					<?php 
						...
						$roomData = array($key, $thisMonth, $today, $thisYear, $room[(date('N') - 1 + $day) % 7]);
					?>
	...
	<?= form_open('/paypal', array('id' => 'dataForm', 'name' => 'dataForm', 'target' => 'hermes')) ?>
...
<iframe name="hermes" src="" style="height: 0; width: 0; display: none;">Your browser doesn't support iFrames.</iframe>
