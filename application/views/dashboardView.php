		...
		<?= form_open_multipart() ?>
			...
			<label for="hotelLogo">Hotel Logo:</label> <span class="imageUpload"><input type="file" /></span> <div class="hinting">This is the hotel logo which will appear throughout the site.<br /> Only PNG files are allowed.</div>
			<input type="submit" />
		<?= form_close() ?>
