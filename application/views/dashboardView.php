		...
		<?= form_open_multipart() ?>
			...
			<label for="hotelLogo">Hotel Logo:</label> <span id="file-uploader"> </span> <div class="hinting">This is the hotel logo which will appear throughout the site.<br /> Only PNG files are allowed.</div>
			<input type="submit" />
		<?= form_close() ?>
